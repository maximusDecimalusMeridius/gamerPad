...
//to run this in Node.js you need to open a command terminal in the root directory and then navigate to the index.js "node db/util/index.js"
...
//                 } if (res.write === 'New') {
//                     const date = dayjs().format('D-M-YY-H-m-s');
...
//             } else if (res.api === 'Skip') {
//                 console.log(`No fetches were made.`);
//             }
//         })
//         .then(async (res) => {
//             const manipulate = await inquirer
//                 .prompt([
//                     {
//                         type: 'input',
